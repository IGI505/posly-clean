...
class DashboardController extends Controller
{
    ...
    public function dashboard_admin(Request $request)
    {
        ...
        $today_sales = $this->render_price_with_symbol_placement(number_format($today_sales, 3, '.', ','));
        ...
        $return_sales = $this->render_price_with_symbol_placement(number_format($return_sales, 3, '.', ','));
        ...
        $today_purchases = $this->render_price_with_symbol_placement(number_format($today_purchases, 3, '.', ','));
        ...
        $return_purchases = $this->render_price_with_symbol_placement(number_format($return_purchases, 3, '.', ','));
