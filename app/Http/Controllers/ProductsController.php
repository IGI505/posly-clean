            ...
            if($user_auth->is_all_warehouses){
                ...
                foreach ($products as $product) {
                    ...
                    if($product->type == 'is_single'){
                      ...
                      $item['cost']  = $this->render_price_with_symbol_placement(number_format($product->cost, 3, '.', ','), $symbol_placement);
                      $item['price'] = $this->render_price_with_symbol_placement(number_format($product->price, 3, '.', ','), $symbol_placement);
                        ...
                        foreach ($product_variant_data as $product_variant) {
                            $item['cost']  .= $this->render_price_with_symbol_placement(number_format($product_variant->cost, 3, '.', ','), $symbol_placement);
                            $item['cost']  .= '<br>';

                            $item['price'] .= $this->render_price_with_symbol_placement(number_format($product_variant->price, 3, '.', ','), $symbol_placement);
                            $item['price'] .= '<br>';
