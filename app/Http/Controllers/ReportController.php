...
class ReportController extends Controller
{
        ...
        if ($user_auth->can('facture_impaye')){
            ...
            if ($request->ajax()) {
                ...
                ->addColumn('GrandTotal', function($row){
                    return number_format($row->GrandTotal, 3, '.', ',');
                })
                ->addColumn('paid_amount', function($row){
                    return number_format($row->paid_amount, 3, '.', ',');
                })
                ->addColumn('due', function($row){
                    return number_format($row['GrandTotal'] - $row['paid_amount'], 3, '.', ',');
                })
    ...
    public function get_report_stock_datatable (Request $request)
    {
       ...
       if ($user_auth->can('report_inventaire')){
            ...
            foreach ($products as $product) {
                ...
                $item['total_current_stock'] =  $product->type !='is_service'?number_format($total_cogs, 3, '.', ','):0;
            ...
            foreach ($products as $product) {
                ...
                if($product->type == 'is_variant') {
                    ...
                    foreach ($variant_id_all as $key => $variant_id) {
                        ...
                        $nestedData['sold_amount'] = number_format($sold_amount, 3, '.', ',');
                        ...
                        $nestedData['sold_qty'] = number_format($sold_qty, 3, '.', '');
                    ...
                    $nestedData['purchased_amount'] = number_format($purchased_amount, 3, '.', ',');
                    ...
                    ->where([
                        ...
                        $nestedData['purchased_qty'] = number_format($purchased_qty, 3, '.', '');
    ...
    public function get_report_clients_datatable(Request $request)
    {
        ...
        if (!$user_auth->can('report_clients')){
            ...
            foreach ($clients as $client) {
                ...
                $item['total_amount']  =  number_format($total_amount, 3, '.', ',');
                ...
                $item['total_paid'] =  number_format($total_paid, 3, '.', ',');

                //---------------
                $due = $total_amount - $total_paid;
                $item['due'] = number_format($due, 3, '.', ',');
                ...
                $item['total_amount_return'] = number_format($total_amount_return, 3, '.', ',');
                ...
                $item['total_paid_return'] = number_format($total_paid_return, 3, '.', ',');

                //--------------

                $item['return_due'] = number_format($total_amount_return - $total_paid_return, 3, '.', ',');
    ...
    public function get_report_providers_datatable(Request $request)
    {
        ...
        if (!$user_auth->can('report_fournisseurs')){
            ...
            foreach ($providers as $provider) {
                ...
                $item['due']  =  number_format($total_amount - $total_paid, 3, '.', ',');
     ...
     public function get_report_sales_datatable(Request $request)
     {
        ...
        if (!$user_auth->can('sale_reports')){
            ...
            foreach ($sales as $sale) {
                ...
                $item['GrandTotal']     = number_format($sale->GrandTotal, 3, '.', ',');
                $item['paid_amount']    = number_format($sale->paid_amount, 3, '.', ',');
                $item['due']            = number_format($sale->GrandTotal - $sale->paid_amount, 3, '.', ',');
    ...
    public function get_report_Purchases_datatable(Request $request)
    {
        ...
        if (!$user_auth->can('purchase_reports')){
            ...
            foreach ($purchases as $purchase) {
                ...
                $item['GrandTotal']     = number_format($purchase->GrandTotal, 3, '.', ',');
                $item['paid_amount']    = number_format($purchase->paid_amount, 3, '.', ',');
                $item['due']            = number_format($purchase->GrandTotal - $purchase->paid_amount, 3, '.', ',');
    ...
    public function get_payment_sale_reports_datatable(Request $request)
    {
        ...
        if (!$user_auth->can('payment_sale_reports')){
            ...
            foreach ($payments as $payment) {
                ...
                $item['montant']        = number_format($payment->montant, 3, '.', ',');
		...
		if ($user_auth->can('payment_return_sale_reports')){
            ...
            if ($request->ajax()) {
                ...
                ->addColumn('montant', function($row){
                    return number_format($row->montant, 3, '.', ',');
    ...
    public function report_profit(Request $request)
    {
		...
		if ($user_auth->can('report_profit')){
            ...
            $item['sales_sum'] =  $this->render_price_with_symbol_placement(number_format($report_total_sales->sum, 3, '.', ','));
            ...
            $item['purchases_sum'] =  $this->render_price_with_symbol_placement(number_format($report_total_purchases->sum, 3, '.', ','));
            ...
            $item['returns_sales_sum']   =   $this->render_price_with_symbol_placement(number_format($report_total_returns_sales->sum, 3, '.', ','));
            ...
            $item['returns_purchases_sum']   =   $this->render_price_with_symbol_placement(number_format($report_total_returns_purchases->sum, 3, '.', ','));
            ...
            $item['paiement_sales'] =  $this->render_price_with_symbol_placement(number_format($report_total_paiement_sales->sum, 3, '.', ','));
            ...
            $item['PaymentSaleReturns'] =  $this->render_price_with_symbol_placement(number_format($report_total_PaymentSaleReturns->sum, 3, '.', ','));
            ...
            $item['PaymentPurchaseReturns'] = $this->render_price_with_symbol_placement(number_format($report_total_PaymentPurchaseReturns->sum, 3, '.', ','));
            ...
            $item['paiement_purchases'] =  $this->render_price_with_symbol_placement(number_format($report_total_paiement_purchases->sum, 3, '.', ','));
            ...
            $item['expenses_sum'] =  $this->render_price_with_symbol_placement(number_format($report_total_expenses->sum, 3, '.', ','));
            ...
            $item['product_cost_fifo']   = $this->render_price_with_symbol_placement(number_format($cogs, 3, '.', ','));
            $item['averagecost']         = $this->render_price_with_symbol_placement(number_format($total_average_cost, 3, '.', ','));
            $item['profit_fifo']         = $this->render_price_with_symbol_placement(number_format($report_total_sales->sum - $cogs, 3, '.', ','));
            $item['profit_average_cost'] = $this->render_price_with_symbol_placement(number_format($report_total_sales->sum - $total_average_cost, 3, '.', ','));
            $item['payment_received']    = $this->render_price_with_symbol_placement(number_format($report_total_paiement_sales->sum  + $report_total_PaymentPurchaseReturns->sum, 3, '.', ','));
            $item['payment_sent']        = $this->render_price_with_symbol_placement(number_format($report_total_paiement_purchases->sum + $report_total_PaymentSaleReturns->sum + $report_total_expenses->sum, 3, '.', ','));
            $item['paiement_net']        = $this->render_price_with_symbol_placement(number_format(($report_total_paiement_sales->sum  + $report_total_PaymentPurchaseReturns->sum)-($report_total_paiement_purchases->sum + $report_total_PaymentSaleReturns->sum + $report_total_expenses->sum), 3, '.', ','));
            $item['total_revenue']       = $this->render_price_with_symbol_placement(number_format($report_total_sales->sum -  $report_total_returns_sales->sum, 3, '.', ','));
    ...
    public function get_sales_history_datatable(Request $request)
    {
        ...
        if (!$user_auth->can('sale_reports')){
            ...
            foreach ($sale_details as $detail) {
                ...
                $item['total']          = $this->render_price_with_symbol_placement(number_format($detail->total, 3, '.', ','));
        ...
        if ($user_auth->can('report_payment_due')){
            ...
            if ($request->ajax()) {
                ...
                ->addColumn('total_paid', function($row){
                    return $this->render_price_with_symbol_placement(number_format($row->total_paid, 3, '.', ','));
                })
