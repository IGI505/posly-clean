...
<head>
    ...
    <!-- Favicon icon -->
    <link rel=icon href={{ asset('images/alshara-png.png') }}>
    <!-- Base Styling  -->
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    @if($symbol_placement == 'before')
                                                        <h6 class="fw-semibold m-0 font_16">{{$currency}} @{{detail.subtotal.toFixed(3)}}</h6>
                                                    @else
                                                        <h6 class="fw-semibold m-0 font_16">@{{detail.subtotal.toFixed(3)}} {{$currency}}</h6>
                                                    @endif
                                    ...
                                    <div class="cart-summery">
                                        ...
                                        <div class="pt-3 border-top border-gray-300 summery-total">
                                            <h5 class="summery-item m-0">
                                                ...
                                                @if($symbol_placement == 'before')
                                                    <span>{{$currency}} @{{GrandTotal.toLocaleString('en-US', {minimumFractionDigits: 3, maximumFractionDigits: 3})}}</span>
                                                @else
                                                    <span>@{{GrandTotal.toLocaleString('en-US', {minimumFractionDigits: 3, maximumFractionDigits: 3})}} {{$currency}}</span>
                                                @endif
                                            </h5>
                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <validation-provider name="Montant à payer"
                                                            ...
                                                            @if($symbol_placement == 'before')
                                                                <span class="badge badge-danger mt-2">{{ __('translate.Total') }} : {{$currency}}  @{{GrandTotal.toLocaleString('en-US', {minimumFractionDigits: 3, maximumFractionDigits: 3})}} </span>
                                                            @else
                                                                <span class="badge badge-danger mt-2">{{ __('translate.Total') }} : @{{GrandTotal.toLocaleString('en-US', {minimumFractionDigits: 3, maximumFractionDigits: 3})}} {{$currency}}</span>
                                                            @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6" v-for="product in products"
                                        ...
                                        <div class="card product-card cursor-pointer">
                                            ...
                                            <div class="quantity">
                                                <span>@{{formatNumber(product.qte_sale , 3)}} @{{product.unitSale}}</span>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    var app = new Vue({
        ...
        methods: {
                ...
                this.$refs.create_pos.validate().then(success => {
                    if (!success) {
                        ...
                        if (this.sale.client_id == "" || this.sale.client_id === null) {
                            toastr.error('{{ __('translate.Please select a client') }}');

                        } else if (
                            this.sale.warehouse_id == "" ||
                            this.sale.warehouse_id === null
                        ) {
                            toastr.error('{{ __('translate.Please select a warehouse') }}');
            ...
            pay_now(){
                this.payment.montant = this.formatNumber(this.GrandTotal, 3);
            ...
            Update_Detail() {
                ...
                for (var i = 0; i < this.details.length; i++) {
                    if (this.details[i].detail_id === this.detail.detail_id) {
                        ...
                        this.detail.Unit_price         = Number((this.detail.Unit_price).toFixed(3));
            ...
            verifiedForm() {
                if (this.details.length <= 0) {
                    toastr.error('{{ __('translate.Please add the product') }}');
                    return false;
                } else {
                    var code_array = [];
                    for (var i = 0; i < this.details.length; i++) {
                ...
                if (this.verifiedForm()) {
                    ...
                    axios
                        .post("/pos/create_pos", {
                            ...
                            montant : parseFloat(this.payment.montant).toFixed(3),
            ...
            CaclulTotal() {
                ...
                if (this.sale.discount_type == 'percent') {
                    ...
                    var grand_total =  this.GrandTotal.toFixed(3);
            ...
            SearchProduct(result) {
                ...
                if(this.load_product){
                    ...
                    toastr.error('{{ __('translate.Please wait until the product is loaded') }}');
                }
