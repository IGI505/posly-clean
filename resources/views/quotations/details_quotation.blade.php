                    ...
                    <table class="table table-hover table-md">
                      ...
                      <tbody>
                        <tr v-for="detail in details">
                          ...
                          <td>@{{formatNumber(detail.quantity,3)}} @{{detail.unit_sale}}</td>
                          <td>@{{formatNumber(detail.price,3)}}</td>
                          <td>@{{formatNumber(detail.DiscountNet,3)}}</td>
                          <td>@{{formatNumber(detail.taxe,3)}}</td>
                          <td>@{{detail.total.toFixed(3)}}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  ...
                  <table class="table table-striped table-sm">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span>@{{quote.TaxNet}} (@{{formatNumber(quote.tax_rate ,3)}} %)</span>
                        </td>
                      </tr>
                      <tr>
