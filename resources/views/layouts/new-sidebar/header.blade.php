    ...
    <div class="d-flex align-items-center button_pos">
        ...
        <div class="button_language dropdown p-2 ms-2">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{route('language.switch','en')}}"> <img class="flag-icon" src="{{asset('assets/flags/en.svg')}}">  English</a></li>
{{--                <li><a class="dropdown-item" href="{{route('language.switch','fr')}}"><img class="flag-icon" src="{{asset('assets/flags/fr.svg')}}">  Frensh</a></li>--}}
                <li><a class="dropdown-item" href="{{route('language.switch','ar')}}"><img class="flag-icon" src="{{asset('assets/flags/om.svg')}}">  Arabic</a></li>
